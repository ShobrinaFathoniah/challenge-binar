    ...
    if (adult) {
      return (
        <View
          style={[
            styles.bubble,
            {backgroundColor: 'red', width: moderateScale(55)},
          ]}>
          <LibreBaskerville style={{textAlign: 'center', color: PRIMARY_DARK}}>
            18+
          </LibreBaskerville>
        </View>
      );
      ...
      <View style={{flexDirection: 'row', marginBottom: moderateScale(10)}}>
        ...
        <View
          ...
          <View style={{marginTop: moderateScale(15)}}>
            ...
            <View style={{flexDirection: 'row'}}>
              {movieType(isAdult)}
              <LibreBaskerville style={[styles.language, styles.text]}>
                {language}
              </LibreBaskerville>
            </View>
          </View>
