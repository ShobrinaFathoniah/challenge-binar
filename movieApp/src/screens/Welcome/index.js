  ...
  return (
    <View style={style.page}>
      ...
      <View style={style.color2}>
        ...
        <Rancho style={[style.text, style.textEnjoy]}>
          Enjoy Your Life With Movie
        </Rancho>
        <Rancho style={[style.text, style.textRelax]}>
          Relax and Find your Favorite Movie
        </Rancho>
        ...
        <View style={{flexDirection: 'row', alignSelf: 'center'}}>
          <TouchableOpacity
            ...
            <LibreBaskerville style={style.textButton}>
              Register
            </LibreBaskerville>
            <View>
              <ButtonCircle
          ...
          <TouchableOpacity
            ...
            <View>
              <ButtonCircle
                style={[style.arrow, style.arrowLogin]}
                onPress={() => navigation.navigate('Login')}
                nameIcon="arrow-right"
              />
            </View>
